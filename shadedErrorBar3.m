...
%Set default options
defaultProps={'-b','Linewidth',3}; %%% I added the 'Linewidth',3 to this to increase the linwidth of the mean 20160629
...
H.mainLine=plot(x,y,lineProps{:});   %%%%%%this is the main line?
